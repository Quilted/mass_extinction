 ...
 *   entirety and paste it here, changing the prefix from theme_ to quilted_custom_.
 *   For example:
 *
 *     original: theme_breadcrumb()
 *     theme override: quilted_custom_breadcrumb()
 *
 *   where quilted_custom is the name of your sub-theme. For example, the
...
if (theme_get_setting('quilted_custom_fixed')) {
 ...
 */
function quilted_custom_theme(&$existing, $type, $theme, $path) {
...
function quilted_custom_preprocess(&$vars, $hook) {
 ...
 */
function quilted_custom_preprocess_page(&$vars, $hook) {
 ...
 */
/* -- Delete this line if you want to use this function
function quilted_custom_preprocess_comment(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
// */
 ...
 */
/* -- Delete this line if you want to use this function
function quilted_custom_preprocess_block(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
// */
